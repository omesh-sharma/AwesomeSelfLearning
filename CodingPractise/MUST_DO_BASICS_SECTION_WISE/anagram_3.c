...
int main()
{
    ...
    // STr1  and str2 could be : silent or listen
    
    printf("Function : whether two given strings are anagram , Example : Silent , listen  :");
...
int checkAnagram(char *str1, char *str2)
{
    ...
    //     // incrementing the all ascii matches count
    //     str1ChrCtr[str1[ctr]]++;
    // }
    ...
    for(ctr = 0; str2[ctr] != '\0' && str1[ctr] != "\0"; ctr++)
    {
        str1ChrCtr[str1[ctr]]++;
        str2ChrCtr[str2[ctr]]++;
    }
    ...
    {   
        // ascii count vakue should match , if not then not a anagram
